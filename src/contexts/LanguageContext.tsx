...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'breathBox.targetCycles': 'Cycles',
    'breathBox.completed': 'Great job!',
    'breathBox.completedDesc': 'You completed {n} breathing cycles',
  ...
  vi: {
    ...
    'breathBox.targetCycles': 'Số vòng',
    'breathBox.completed': 'Tuyệt vời!',
    'breathBox.completedDesc': 'Bạn đã hoàn thành {n} vòng thở',
